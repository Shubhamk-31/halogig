...
//         appVersion, deviceType, firstName, lastName, email,
//       } = body;
...
//           const customerData = {
//             name: `${firstName} ${lastName}` || 'halogig Customer',
//             email: email || 'halogig@gmail.com',
...
//       if (guestUserData) {
//         const userData = guestUserData.get();erRole: 'guest', status: 'active' } });
