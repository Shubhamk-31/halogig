...
export default {
  ...
  async sendToAndroidUser(deviceId, requestData, unreadCount) {
    ...
    const data = {
      sound: defaultSound,
      message: requestData ? requestData.message.toString() : 'halogig',
      title: requestData ? requestData.title.toString() : 'halogig',
      type: requestData ? requestData.type.toString() : 'halogig',
    };
  ...
  async sendToIosUser(deviceId, requestData, unreadCount) {
    ...
    const payload = {
      notification: {
        title: notificationData ? notificationData.title.toString() : 'halogig',
