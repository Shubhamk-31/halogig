export default {
  ...
  VERIFICATION_PENDING: 'You will get notified once your profile us approved by admin',
 ...
 */
  ...
  */
   ...
   * Email subject
   */
  RESET_PASSWORD_EMAIL: 'halogig – Reset your password!',
  ACCOUNT_CHANGE_PASSWORD_EMAIL: 'halogig - Account Password Changed',
  SELLER_STATUS_UPDATED_EMAIL: 'halogig - Welcome to halogig Platform',
  SELLER_REQUEST_REJECTED_EMAIL: 'halogig - Account Request Rejected',
  SELLER_REQUEST_APPROVED_EMAIL: 'halogig - Account Request Approved',
  ACTIVE_STATUS_UPDATED_EMAIL: 'halogig - Your Account has been Activated',
  INACTIVE_STATUS_UPDATED_EMAIL: 'halogig - Your Account has been Restricted',
  STAFF_ADD_EMAIL: 'halogig - Staff created',
   ...
   * Sms message
   */
  OTP_MESSAGE: '{otp} is your one time password to proceed on halogig. It is valid for 10 minutes. Do not share your OTP with anyone.',
  PROMOTIONAL_SMS_MESSAGE: 'Thanks for registering. You will get a lovely link to download our mobile app when we launch ❤️. Stay tuned! Xoxo, halogig',
  ...
  GET_EARLY_CONTACT_US_ADDED: 'Text Confirmation on the way! Xoxo, halogig',
  GET_EARLY_ACCESS_ALREADY_EXIST: 'Thanks for contacting us again. Stay tuned for our launch updates. ❤️ halogig',
  ...
  */
  ...
  PRODUCT_NOTIFY_ME_EXIST: 'Product notify me already exist',
  ...
  */
  ORDER_PLACED: 'Order {orderId} has been placed successfully. Thank you for shopping at halogig.',
  ...
  ORDER_DELIVERED: 'Your Order {orderId} has been delivered successfully. Please help to rate your experience with halogig. Please write reviews which will help us to serve you better.',
